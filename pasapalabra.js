...
const bd_juego = [
  ...
  {
    id:'B',
    pregunta:"Lenguaje que entienden las computadoras",
    respuesta:"binario"
  },
  {
    id:'C',
    pregunta:"Conjunto de elementos que se combinan siguiendo reglas",
    respuesta:"codigo"
  },
  {
    id:'D',
    pregunta:"Servicio de alojamiento de archivos en la nube desarrollado por Google",
    respuesta:"drive"
  },
  {
    id:'E',
    pregunta:"Programa desarrollado por Microsoft que nos permite crear hojas de calculo y tablas",
    respuesta:"excel"
  },
  {
    id:'F',
    pregunta:"Documentos que recogen la información de las personas",
    respuesta:"formularios"
  },
  {
    id:'G',
    pregunta:"Unidad de almacenamiento de información",
    respuesta:"gb"
  },
  {
    id:'H',
    pregunta:"Lenguaje de programación que se utiliza para crear la estructura de las páginas web",
    respuesta:"html"
  },
  {
    id:'I',
    pregunta:"Ciencia que estudia el desarrollo de las computadoras y redes, que también se le conoce como ciencia de las computadoras",
    respuesta:"informatica"
  },
  {
    id:'J',
    pregunta:"Lenguaje de programación que nos permite que las páginas web sean más dinámicas con el usuario",
    respuesta:"javascript"
  },

  {
    id:'K',
    pregunta:"unidad de medidad de almacenamiento de la información",
    respuesta:"kilobyte"
  },

  {
    id:'L',
    pregunta:"sistema de comunicación compuesto con signos, que tiene el fin de transmitir información. ",
    respuesta:"lenguaje"
  },

  {
    id:'M',
    pregunta:"Empresa tecnológica creada por Bill Gate",
    respuesta:"microsoft"
  },

  {
    id:'N',
    pregunta:"Es un software, programa o aplicacion que nor permite tener acceso a la web. Entre los más conocidos, se encuentra Chrome",
    respuesta:"navegador"
  },

  {
    id:'O',
    pregunta:"Es un software, que contiene distintas herramientas ofimáticas.",
    respuesta:"office"
  },

  {
    id:'P',
    pregunta:"Es un formato de almacenamiento para documentos digitales. ",
    respuesta:"pdf"
  },
]
...
// Creamos el círculo con las letras de la A a la Z en orden inverso
const container = document.querySelector(".container");
for (let i = TOTAL_PREGUNTAS; i >= 1; i--) {
